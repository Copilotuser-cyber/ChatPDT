      ...
      <div className="w-full max-w-md z-10">
        <div className="bg-slate-900/80 backdrop-blur-xl p-8 rounded-3xl border border-slate-800 shadow-2xl">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-400 text-sm font-medium">{isLogin ? 'Sign in to your account' : 'Create a new account'}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-black py-4 rounded-xl shadow-xl shadow-indigo-600/20 transition-all uppercase text-[11px] tracking-widest">{isLogin ? 'Log In' : 'Sign Up'}</button>
