...
export const MODELS = [
  ...
  // Fix: Standardizing model name alias for Gemini Flash Lite
  { id: 'gemini-flash-lite-latest', name: 'Gemini Flash Lite', description: 'Ultra-low latency for simple queries.' }
];
...
export const AVATAR_PRESETS = [
  ...
  "https://api.dicebear.com/7.x/bottts-neutral/svg?seed=Max",
  "https://api.dicebear.com/7.x/bottts-neutral/svg?seed=Leo",
  "https://api.dicebear.com/7.x/bottts-neutral/svg?seed=Milo",
  "https://api.dicebear.com/7.x/bottts-neutral/svg?seed=Ruby",
  "https://api.dicebear.com/7.x/bottts-neutral/svg?seed=Jasper",
  "https://api.dicebear.com/7.x/avataaars/svg?seed=Ferdinand",
  ...
  "https://api.dicebear.com/7.x/pixel-art/svg?seed=Ollie",
  "https://api.dicebear.com/7.x/pixel-art/svg?seed=Annie",
  ...
  "https://api.dicebear.com/7.x/bottts-neutral/svg?seed=Cyber",
  "https://api.dicebear.com/7.x/avataaars/svg?seed=Hero",
  "https://api.dicebear.com/7.x/big-ears-neutral/svg?seed=Elf"
];
